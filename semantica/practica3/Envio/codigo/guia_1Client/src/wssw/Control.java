...
public class Control extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		case 10:
			resultado = guia.getDescripcionDeContenidos();
			atributos.add("Tema:");
			atributos.add("  ");
		...
		case 11:
			resultado = guia.getActividadesPresenciales();
			
			ponSalto=true;
			break;
			
		case 12:
			resultado = guia.getActividadesNoPresenciales();
			
			ponSalto=true;
			break;
			
		case 13:
			resultado = guia.getMetodologiaDocente();
			atributos.add("");
			
			break;
			
		case 14:
			resultado = guia.getEvaluacion();
			atributos.add("");
			ponSalto=true;
			break;
			
		case 15:
			resultado = guia.getReferenciasBasicas();
			atributos.add("");
			ponSalto=true;
			break;
			
		case 16:
			resultado = guia.getReferenciasComplementarias();
			atributos.add("");
			ponSalto=true;
			break;
