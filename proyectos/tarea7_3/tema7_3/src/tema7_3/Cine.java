...
public class Cine {
    ...
    /**
     * Constructor con argumentos. Nombre, direccion, telefono, poblacion,
...
/////////////////////////////////////////////////////////////////////////////
    ...
    public ArrayList<String> ListarPoblacionesConCine(Provincia provincia) throws SQLException {
    ...
    public ArrayList<String> BuscarPeliPorActor(Actor actor) throws SQLException {

        return actor.getPeliculas();
    }

    public ArrayList<String> haySesion(int pelicula, String hora) throws Exception {
        /*int num_libres;
        ...
        ResultSet r = db.consultar(conexion, "select * from sesion where id_pelicula=" + pelicula + " and hora='" + hora + "'", stat);
    ...
    public boolean ComprarEntrada(int idSesion, int num_entradas) throws SQLException {
        int numEntradas;
        ...
        ResultSet r=db.consultar(conexion, "select * from sesion where id_sesion="+idSesion, stat);
        r.first();
        numEntradas=r.getInt("entradas");
        if (numEntradas-num_entradas>=0){
           result=true; 
        }
        
        db.ejecutar("UPDATE sesion SET entradas="+numEntradas+" where id_sesion="+idSesion, stat);
